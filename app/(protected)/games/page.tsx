...
export default function GamesLobby() {
  ...
  return (
    <main className="flex-1 flex flex-col h-full overflow-hidden bg-surface-50 dark:bg-slate-950 p-6 gap-6 relative">
      <Header
        title="Gaming Arena"
        subtitle="Experience high-density multiplayer competitive sessions"
        icon={<FiShield className="w-5 h-5 text-white" />}
      >
        <button
          onClick={() => setIsHistoryOpen(true)}
          className="flex items-center gap-2 px-4 py-2 rounded-[4px] bg-primary-50 dark:bg-primary-500/10 text-primary-600 dark:text-primary-400 hover:bg-primary-100 transition-all font-black text-xs uppercase tracking-widest border border-primary-200/50"
        >
      ...
      <div className="flex-1 overflow-y-auto w-full space-y-8 custom-scrollbar rounded-[4px]">
        {/* Arena Host Persona Section */}
        <div className="bg-white dark:bg-slate-900 rounded-[4px] p-8 border border-primary-100 dark:border-slate-800 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center gap-8">
          <div className="relative z-10 w-32 h-32 md:w-36 md:h-36 flex-shrink-0 flex items-center justify-center bg-primary-50 dark:bg-primary-500/10 rounded-full border border-primary-100 dark:border-slate-800 overflow-hidden shadow-inner">
            <img
          ...
          <div className="relative z-10 text-center md:text-left flex-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-100 dark:bg-primary-500/20 text-primary-600 dark:text-primary-400 text-[10px] font-black uppercase tracking-widest mb-4">
              <FiTrendingUp className="w-3 h-3" /> Live Operations Active
            </div>
            <h2 className="text-2xl md:text-3xl font-black text-surface-900 dark:text-white mb-3 tracking-tighter">
              Welcome to the Arena.
            </h2>
            <p className="text-sm md:text-base text-surface-500 dark:text-slate-400 font-medium leading-relaxed">
              I'm your host for today's sessions. Whether you're here to dominate in{' '}
              <span className="text-primary-600 dark:text-primary-400 font-bold">Bingo</span> or
              outsmart your opponent in{' '}
              <span className="text-indigo-600 dark:text-indigo-400 font-bold">Tic-Tac-Toe</span>,
              I'll be tracking your performance across the global leaderboards.
            </p>
          </div>
        </div>

        {/* Join Room - Enterprise Redesign */}
        <div className="bg-primary-900 dark:bg-slate-800 rounded-[4px] py-4 px-6 md:py-5 md:px-10 text-white shadow-2xl relative overflow-hidden">
          <div
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-6 justify-between">
            <div className="text-center lg:text-left">
              <h3 className="text-lg font-black mb-1 tracking-tight flex items-center gap-2 justify-center lg:justify-start">
                <FiPlus className="text-primary-400" /> Join a Secure Session
              </h3>
              <p className="text-[11px] text-primary-100 opacity-80 font-medium">
                Enter a room code to synchronize with your opponent instantly.
              </p>
            </div>
            ...
            >
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-2.5 bg-primary-500 hover:bg-primary-600 text-white rounded-[4px] font-black uppercase tracking-widest text-[11px] shadow-xl shadow-primary-500/30 transition-all active:scale-95 disabled:opacity-50"
              >
                Connect Now
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {/* Tic Tac Toe Card */}
          <div
            className="group relative h-[200px] cursor-pointer overflow-hidden rounded-[4px] border border-indigo-500/20 shadow-2xl transition-all hover:scale-[1.02] hover:shadow-indigo-500/20 md:h-[240px]"
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-6 z-10 w-full">
              ...
              <h2 className="mb-1 text-2xl font-black tracking-tighter text-white drop-shadow-md">Tic-Tac-Toe</h2>
              <p className="text-[10px] font-black tracking-widest text-indigo-200 uppercase drop-shadow-sm">
          ...
          {/* Bingo Card */}
          <div
            className="group relative h-[200px] cursor-pointer overflow-hidden rounded-[4px] border border-emerald-500/20 shadow-2xl transition-all hover:scale-[1.02] hover:shadow-emerald-500/20 md:h-[240px]"
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-6 z-10 w-full">
              ...
              <h2 className="mb-1 text-2xl font-black tracking-tighter text-white drop-shadow-md">Bingo Arena</h2>
              <p className="text-[10px] font-black tracking-widest text-emerald-200 uppercase drop-shadow-sm">
          ...
          <div
            className="group relative h-[200px] cursor-not-allowed overflow-hidden rounded-[4px] border border-orange-500/10 shadow-xl transition-all grayscale opacity-80 hover:opacity-100 md:h-[240px]"
          >
            <Image
            ...
            <div className="absolute inset-0 flex items-center justify-center p-6 text-center">
              <div className="bg-orange-500/10 border border-orange-500/30 backdrop-blur-xl px-4 py-2 rounded-[4px]">
                <span className="text-[10px] font-black tracking-[0.3em] text-orange-500 uppercase">Coming Soon</span>
              </div>
            </div>
            <div className="absolute bottom-0 left-0 p-6 z-10 w-full">
              <h2 className="mb-1 text-2xl font-black tracking-tighter text-white/50">Drawing Guess</h2>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-surface-400 font-bold uppercase tracking-widest">
                      {history.length} Sequence Records
                    </p>
                  </div>
                </div>
                <button
